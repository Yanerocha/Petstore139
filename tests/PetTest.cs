...
public static IEnumerable<TestCaseData> getTestData()
    ...
    public void PostPetTest()
    {
        ...
        Assert.That(petId, Is.EqualTo(5593045));

        // Valida o nome do animal na resposta
        String name = responseBody.name.ToString();
        Assert.That(name, Is.EqualTo("Jimmy"));
        // OU
        // Assert.That(responseBody.name.ToString(), Is.EqualTo("Jimmy"));
    ...
    {
        // Configura
        int petId = 5593045;            // campo de pesquisa
        String petName = "Jimmy";      // resultado esperado
